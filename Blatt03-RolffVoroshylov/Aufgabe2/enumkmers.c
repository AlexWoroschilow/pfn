...
*/
bool maximumReached(const unsigned long* array,
                    const long strsize)
{
...
*/
void printArray(const char* string,
...
*/
void increment(unsigned long* array,
               const long strsize,
               const long k)
{
  unsigned long i;
...
*/
void permutateAlphabet(const char* string,
                       const long strsize,
                       const long k)
{
  unsigned long i;
